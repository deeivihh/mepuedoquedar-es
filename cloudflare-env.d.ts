/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: f2ac3582b408015fa8f1dc9efc11589f)
// Runtime types generated with workerd@1.20260721.1 2026-07-23 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* sparkling-dream-f4e2 */;
}
