    ...
    return (
        <Link
            ...
            className={`flex justify-between w-full items-center gap-4 ${
                isHome
                    ? "px-3 py-2 border border-title/50 hover:bg-bg-card/50 active:bg-bg-card"
                    : "p-2 border border-title/30 hover:bg-white/50 active:bg-white"
            }`}
        >
            ...
            {result.distance != null && (
                <div className="flex items-center justify-center gap-1.5 shrink-0 text-title/80">
                    <span className="font-medium text-sm text-right" title="Distancia desde tu ubicación actual">
                        <FaRoute />
                    </span>
