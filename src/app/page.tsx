        ...
        <main className="flex flex-col justify-start h-screen w-full max-md:p-6">
            <footer className="absolute left-1/2 -translate-x-1/2 bottom-4 max-lg:top-8">
                <div className="flex gap-2 items-start justify-center">
                    <Link
                        href="/metodologia"
                        className="text-title/75 hover:text-title leading-relaxed text-sm flex items-center justify-center gap-2"
                    >
                        <FaProjectDiagram />
                        Metodología
                    </Link>
                    ...
                    <Link
                        ...
                        className="text-title/75 hover:text-title leading-relaxed text-sm mb-4 flex items-center justify-center gap-2"
                    >
                        <FaGithub />
                        Repositorio
                    </Link>
            ...
            <section className="h-full flex flex-col justify-center items-center mb-24">
                <DynamicHeading />
                <SearchBar />
            </section>
        </main>
